...
bot.on('message', function (message) {
	...
	if ((message.content === '!buy Ambre') || (message.content === '!buy ambre') || (message.content === '!buy AMBRE')){
		...
		//Emeraude
		} else if (message.member.roles.has("486903533992673282")) {
			message.member.removeRole("486903533992673282").catch(console.error)

		//Or
		} else if (message.member.roles.has("486904003976888320")) {
			message.member.removeRole("486904003976888320").catch(console.error)

		//Amethyste
		} else if (message.member.roles.has("486903705237717003")) {
			message.member.removeRole("486903705237717003").catch(console.error)

		//Bonbon
		} else if (message.member.roles.has("486903647855443979")) {
			message.member.removeRole("486903647855443979").catch(console.error)

		//Argent
		} else if (message.member.roles.has("486903925719433237")) {
			message.member.removeRole("486903925719433237").catch(console.error)

		//Saphir
		} else if (message.member.roles.has("486903357399891968")) {
			message.member.removeRole("486903357399891968").catch(console.error)

		//Diamant
		} else if (message.member.roles.has("486904137976512542")) {
			message.member.removeRole("486904137976512542").catch(console.error)

		//Rubis
		} else if (message.member.roles.has("486904462514978826")) {
			message.member.removeRole("486904462514978826").catch(console.error)
		}
	...
	//Amethyste
		...
		//Ambre
		} else if (message.member.roles.has("486903837974855681")) {
			message.member.removeRole("486903837974855681").catch(console.error)
	...
	//Argent
		...
		//Larimar
		} else if (message.member.roles.has("486904294621052929")) {
			message.member.removeRole("486904294621052929").catch(console.error)
